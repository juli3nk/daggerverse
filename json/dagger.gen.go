...
func (r *Json) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Json":
		...
		case "ContainerEcho":
			...
			return (*Json).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Json
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Json).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
