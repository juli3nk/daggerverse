...
func (r *Yaml) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Yaml":
		...
		case "ContainerEcho":
			...
			return (*Yaml).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Yaml
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Yaml).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
